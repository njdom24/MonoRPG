...
namespace RPG
{
	class NewNPC
	{
		...
		public NewNPC(World world, ContentManager content, int[][] colArray, int steps, bool vertical, int posX, int posY, string[] messages, int textWidth = 20, int textHeight = 3)
		{
